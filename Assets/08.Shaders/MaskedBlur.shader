// taken from here: https://stackoverflow.com/questions/29030321/unity3d-blur-the-background-of-a-ui-canvas
// Shaders are on my TODO, but I'm not ready to dive into that just yet.
      ...
      */
      ...
      {      
        ...
        {   
          ...
          half4 result = half4(
            sum.r * _MultiplyColor.r + _AdditiveColor.r, 
